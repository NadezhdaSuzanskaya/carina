...
public class HomePage extends HomePageBase {
    ...
    //------------my code-----------------------------
    @FindBy(css= "#login-active") //id = "file-upload"
    private ExtendedWebElement loginMenuIcon;

    @FindBy(xpath ="//a[@id='login-active']//span")
    private ExtendedWebElement loginIconTooltip;
//--------------------------------------------------------
...
{loginMenuIcon.click();}
    ...
    public boolean checkTooltipPresent()
    {
        if ((loginIconTooltip.isVisible())&&(loginIconTooltip.getText().toLowerCase(Locale.ROOT).equals("log in")))
        return true;
        else
            return false;
